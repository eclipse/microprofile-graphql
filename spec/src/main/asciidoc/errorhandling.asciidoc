...
Also note that this configuration will indicate all instances of exceptions of the exception class, transitively. 

Example, if you have an exception that extends the above mentioned `WeaknessNotFoundException`, the whitelist will still apply to that specialization.
...
Example, if you have an exception that extends the above mentioned `IOException`, the blacklist will still apply to that specialization.
