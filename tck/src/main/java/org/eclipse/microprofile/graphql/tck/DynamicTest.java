...
import org.eclipse.microprofile.graphql.tck.data.PrintUtil;
import org.eclipse.microprofile.graphql.tck.data.TestData;
...
import org.eclipse.microprofile.graphql.tck.data.GraphQLDataProvider;
 ...
 */
public class DynamicTest extends Arquillian {
    private static final Logger LOG = Logger.getLogger(DynamicTest.class.getName());   
    ...
    @RunAsClient
    @Test(dataProvider="specification", dataProviderClass = GraphQLDataProvider.class)
    public void testSpecification(TestData testData){
        runTest(testData);
    }
    
    @RunAsClient
    @Test(dataProvider="implementation", dataProviderClass = GraphQLDataProvider.class)
